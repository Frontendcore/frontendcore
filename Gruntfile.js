module.exports = function (grunt) {
	...
	grunt.registerTask('release', ['version','twigRender','scss','js','gitadd:scss','gitadd:js','gitcommit:scss','gitcommit:js','gitadd:workspace','gitcommit:workspace','gittag','gitpush']);
