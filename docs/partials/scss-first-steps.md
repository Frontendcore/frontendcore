##Step 1
Download & Copy FrontendCore SCSS to your statics folder

-------------------------------------------
##Step 2
Import the index.scss at the main file of your project:

	    @import "frontendcore/scss/index.scss"

-------------------------------------------
##Step 3
Set the variables to customize Look & feel:
