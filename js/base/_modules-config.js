...
var oDefaultPaths = {
	...
	aModules = ['devicePackage','sidemenu','code','sortable','tags','modal','autocomplete','autosize','graph','stats','wysiwyg','truncate','tip','cart','polyfills','parallax','carousel','table','toggle','tabs','notification','dropdown','center-box'];
