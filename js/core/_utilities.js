...
CORE.utilities.mixOptions = function( oOptions, oSettings ) {
    var key;
...
CORE.utilities.loadCSS = function(oSettings) {

   // Load the CSS
    if ( oSettings.pathCss && oGlobalSettings.bCss && CORE.globals.css[oSettings.pathCss] !== true ) {
        // Load the CSS
        $(document.body).append('<link rel="stylesheet" type="text/css" href="' + oSettings.pathCss + '" />');

        CORE.globals.css[oSettings.pathCss] = 'true';
    }
