module.exports = function(grunt) {
	...
	if (oData !== undefined) {
		...
		oCore.files[ jsDest + '/frontendcore.js'] = [
			...
			fcCwd + '/lib/tinycorejs/build/TinyCore.js',
			fcCwd + '/lib/tinycorejs/src/tools/mediator/TinyCore.Toolbox.Mediator.js',
			fcCwd + '/lib/tinycorejs/build/extensions/AMD/require-2.1.4.min.js',
			fcCwd + '/lib/tinycorejs/src/extensions/AMD/TinyCore.AMD.js',
			fcCwd + '/lib/tinycorejs/src/extensions/AMD/TinyCore.AMD.domBoot.js',
			fcCwd + '/lib/jquery/dist/jquery.js',
		...
		oCore.files[jsDest + '/ui/swipe.js'] = [
			fcCwd + '/lib/jquery-touchswipe/jquery.touchSwipe.js',
		...
		oCore.files[jsDest + '/ui/tel-field-libs.js'] = [
			fcCwd + '/lib/intl-tel-input/intlTelInput.js',
			fcCwd + '/lib/intl-tel-input/utils.js'
		];
		
		// PASSWORD METER
		oCore.files[jsDest + '/ui/password-meter.js'] = [
			fcCwd + '/lib/strength-meter/js/strength-meter.js',
